        ...
        <div class="flex justify-center">
            <main class="ml-64 p-8">
                ...
                <form class="bg-white shadow-md rounded-lg p-6" @submit.prevent="submitForm">
                    ...
                    <input type="text" id="store-id" class="w-full p-2 border rounded-md" v-model="form.store_id" placeholder="Enter Store ID" required>
                    </div>
    
                    <div class="mb-4">
                    <label for="store-password" class="block text-gray-700 font-bold mb-2">Store Password</label>
                    <input type="password" id="store-password" class="w-full p-2 border rounded-md" v-model="form.store_password" placeholder="Enter Store Password" required>
                    </div>
    
                    <div class="mb-4">
                    <label for="api-endpoint" class="block text-gray-700 font-bold mb-2">Currency</label>
                    <input type="text" id="api-endpoint" class="w-full p-2 border rounded-md" v-model="form.currency" placeholder="Enter API Endpoint (e.g., https://sandbox.sslcommerz.com)" required>
                    </div>
                    ...
                    <input type="text" id="fail-url" class="w-full p-2 border rounded-md" v-model="form.fail_url" placeholder="Enter Fail URL (e.g., /payment/fail)" required>
                    </div>
    
                    <div class="mb-4">
                    <label for="cancel-url" class="block text-gray-700 font-bold mb-2">Cancel URL</label>
                    <input type="text" id="cancel-url" class="w-full p-2 border rounded-md" v-model="form.cancel_url" placeholder="Enter Cancel URL (e.g., /payment/cancel)" required>
                    </div>
